...
namespace PizzaCore.Migrations {
  ...
  [Migration("20211201151510_order")]
  partial class order {
...
#pragma warning disable 612, 618
      ...
      modelBuilder.Entity("PizzaCore.Data.Entities.CartItem", b => {
        b.Property<int>("Id")
            .ValueGeneratedOnAdd()
            .HasColumnType("int")
            .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
      ...
      modelBuilder.Entity("PizzaCore.Data.Entities.CartItem", b => {
        b.HasOne("PizzaCore.Models.OrderModel", null)
            .WithMany("Items")
            .HasForeignKey("OrderModelId");

        b.HasOne("PizzaCore.Data.Entities.ProductSize", "ProductSize")
            .WithMany()
